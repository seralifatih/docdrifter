...
export function termsPage(): string {
  ...
  <p>Payments are processed under the trading name <strong>LoopSignal</strong>, which is the Paddle account operating DocDrifter — that name appears on the checkout page, your receipt, and your card statement.</p>

  <p>DocDrifter is free for public repositories. Private repositories each require one seat on an active subscription, billed monthly at $9 per seat through Paddle. You choose which private repos hold your seats, and can move a seat between repos at any time from the dashboard at no extra cost. If a subscription lapses, or its seat count is reduced below the number of repos using them, DocDrifter stops evaluating PRs on the repos that are no longer covered — it does not delete or modify anything in your repository.</p>
