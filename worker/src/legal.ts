...
export function termsPage(): string {
  ...
  <p>DocDrifter is free for public repositories. Private repositories require an active subscription, billed monthly per repository through Paddle. If a private repo's subscription lapses, DocDrifter stops evaluating its PRs until it's reactivated — it does not delete or modify anything in your repository.</p>
